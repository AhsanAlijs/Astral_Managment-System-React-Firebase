            ...
            <main className="max-w-screen-2xl mx-auto min-h-screen w-full text-gray-700" x-data="layout">
                ...
                <header className="flex w-full items-center justify-between border-b-2 border-gray-200 bg-white p-2">
                    ...
                    <div>
                        ...
                        >
                            <img src="https://plchldr.co/i/40x40?bg=111111" alt="plchldr.co" className="h-16 w-16" />
                        </button>

                        {/* dropdown profile */}
                        {profileOpen && (
                            <div className="absolute right-[180px] mt-3 w-48 divide-y divide-gray-200 rounded-md border border-gray-200 bg-white shadow-md">
                ...
                <div className="flex min-h-[calc(100vh_-_60px)]">
                    {/* aside */}
                    <aside className={`flex w-72 mt-[5px] flex-col space-2  border-2 rounded-md  border-black-200 bg-white p-4 ${asideOpen ? '' : 'hidden'} translate-10 `}>
